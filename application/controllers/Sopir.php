...
class Sopir extends CI_Controller
{
    ...
    {
        $sopir = $this->sopir_model->get_all();
    ...
    {
        $row = $this->sopir_model->get_by_id($id);
        if ($row) {
            $data = array(
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('sopir/create_action'),
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('sopir/update_action'),
    ...
    public function update_action() 
    {
		...
		'sopir_status' => $this->input->post('sopir_status',TRUE),
            ...
            $this->sopir_model->update($this->input->post('sopir_id', TRUE), $data);
